...
const Hero = () => {
  return (
    <section
      className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8  mt-4"
      id="hero"
    >
      <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
            ...
            <span className="text-blue-600">MultiVendor.ke</span>
          </h1>
          <p className="mt-3 text-lg text-gray-800 dark:text-gray-400">
            Professionals and expertly crafted products, designed for any kind
          ...
          <div className="mt-7 grid gap-3 w-full sm:inline-flex">
            ...
            >
              Get started
              <FaAngleRight className="flex-shrink-0 size-4" />
            </a>
          </div>
          <div className="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
            <div className="py-5">
              <div className="flex space-x-1">
                <IoIosStar className="size-5 text-gray-800 dark:text-gray-200" />
                <IoIosStar className="size-5 text-gray-800 dark:text-gray-200" />
                <IoIosStar className="size-5 text-gray-800 dark:text-gray-200" />
                <IoIosStar className="size-5 text-gray-800 dark:text-gray-200" />
              </div>
            ...
            <div className="py-5">
              <div className="flex space-x-1">
                ...
                <IoIosStar className="size-5 text-gray-800 dark:text-gray-200" />
                <IoIosStar className="size-5 text-gray-800 dark:text-gray-200" />
                <IoStarHalf className="size-5 text-gray-800 dark:text-gray-200" />
              </div>
